...
export function AuthShell({
  ...
  return (
    <div className="relative flex min-h-[calc(100vh-4rem)] items-center justify-center overflow-hidden py-12">
      ...
      <div className="pointer-events-none absolute -right-16 bottom-10 h-72 w-72 rounded-full bg-emerald-400/10 blur-3xl animate-float" />
      <div className="relative w-full max-w-md px-4">
        <div className="card animate-scale-in">
          <Link href="/" className="mb-6 flex items-center justify-center gap-2 font-bold text-slate-900">
            <span className="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-brand text-white">Ұ</span>
